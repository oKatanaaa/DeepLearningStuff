    ...
    def fit(self, Xtrain, Ytrain, Xtest, Ytest, 
        ...
        for i in range(epochs):
            ...
            for j in range(n_batches):
                ...
                # Updating weights
                self.W2 += mu*v_W2 + learning_rate*der_W2
                self.b2 += mu*v_b2 + learning_rate*der_b2
                self.W1 += mu*v_W1 + learning_rate*der_W1
                self.b1 += mu*v_b1 + learning_rate*der_b1
        ...
        fig.savefig('nesterov_momentum_costs.png')
        ...
        axes.set_xlabel('Iteration')
        fig.savefig('nesterov_momentum_error.png')
        return errors
