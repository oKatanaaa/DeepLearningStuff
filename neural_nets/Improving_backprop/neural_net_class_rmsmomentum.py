    ...
    def fit(self, Xtrain, Ytrain, Xtest, Ytest, 
        ...
        for i in range(epochs):
            ...
            for j in range(n_batches):
                ...
                # Updating velocities
                v_W2 = mu*v_W2 + learning_rate*der_W2
                v_b2 = mu*v_b2 + learning_rate*der_b2
                v_W1 = mu*v_W1 + learning_rate*der_W1
                v_b1 = mu*v_b1 + learning_rate*der_b1
                
                # Updating weights
                self.W2 += mu*v_W2 + learning_rate*der_W2/np.sqrt(cache_W2 + eps)
                self.b2 += mu*v_b2 + learning_rate*der_b2/np.sqrt(cache_b2 + eps)
                self.W1 += mu*v_W1 + learning_rate*der_W1/np.sqrt(cache_W1 + eps)
                self.b1 += mu*v_b1 + learning_rate*der_b1/np.sqrt(cache_b1 + eps)
